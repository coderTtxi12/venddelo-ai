  ...
  return (
    <div className={styles.container}>
      <div className={styles.imagePanel}>
        ...
        <img src="/assets/portada2.jpg" alt="Mexy AI" className={styles.coverImage} />
        <div className={styles.imageOverlay}>
          <p className={styles.quote}>
            &quot;La plataforma que necesitas para gestionar tu menú digital.&quot;
          </p>
          <span className={styles.author}>Mexy AI Team</span>
        </div>
      </div>

      <div className={styles.formPanel}>
        <div className={styles.formContent}>
          <h1 className={styles.title}>Bienvenido a Mexy AI</h1>
