...
export const THEME_ADD_SUCCESS: Record<string, ThemeAddSuccessTokens> = {
  ...
  // ── Soft & color (tinted surfaces) — success = vivid sibling of theme accent ──
  'soft-order': { addSuccess: '#FF9A4D', addSuccessText: '#1C1917' },
  'bubble-mint': { addSuccess: '#34E89A', addSuccessText: '#064E3B' },
  'peach-soft': { addSuccess: '#FF8AA8', addSuccessText: '#4C0519' },
  'berry-soft': { addSuccess: '#E879F9', addSuccessText: '#4A044E' },
  'sky-soft': { addSuccess: '#5CC8FF', addSuccessText: '#0C4A6E' },
  'citrus-soft': { addSuccess: '#B8F000', addSuccessText: '#1A2E05' },
  'ink-blue': { addSuccess: '#5B9FFF', addSuccessText: '#1E3A8A' },
  'forest-clean': { addSuccess: '#3DDC97', addSuccessText: '#022C22' },
  'amber-pulse': { addSuccess: '#FFB020', addSuccessText: '#0F172A' },
  'slate-indigo': { addSuccess: '#8B8CFF', addSuccessText: '#1E1B4B' },
  'teal-trust': { addSuccess: '#2EE6C8', addSuccessText: '#134E4A' },
  'editorial-ink': { addSuccess: '#E8C547', addSuccessText: '#1C1917' },
  'rose-neutral': { addSuccess: '#FF7A9A', addSuccessText: '#4C0519' },
  'graphite-lime': { addSuccess: '#B8F000', addSuccessText: '#18181B' },
  'copper-modern': { addSuccess: '#FF9A4A', addSuccessText: '#431407' },

  // ── Pure white canvas essentials — success stays in each accent hue family ──
  'white-crimson': { addSuccess: '#FF6B6B', addSuccessText: '#450A0A' },
  'white-violet': { addSuccess: '#B794FF', addSuccessText: '#1E1B4B' },
  'white-navy': { addSuccess: '#4D8FFF', addSuccessText: '#0F172A' },
  'white-emerald': { addSuccess: '#34E89A', addSuccessText: '#022C22' },
  'white-fuchsia': { addSuccess: '#FF5CB0', addSuccessText: '#4A044E' },
  'white-amber': { addSuccess: '#FFB020', addSuccessText: '#431407' },
  'white-cyan': { addSuccess: '#2AD4E8', addSuccessText: '#0C4A6E' },
  'white-royal': { addSuccess: '#7B7EFF', addSuccessText: '#1E1B4B' },
  'white-wine': { addSuccess: '#FF6B8A', addSuccessText: '#4C0519' },
  'white-olive': { addSuccess: '#A8E030', addSuccessText: '#1A2E05' },
  'white-sunset': { addSuccess: '#FF7A6A', addSuccessText: '#4C0519' },
  'white-ocean': { addSuccess: '#2DD4BF', addSuccessText: '#134E4A' },
  'white-plum': { addSuccess: '#C084FC', addSuccessText: '#4A044E' },
  'white-impact': { addSuccess: '#FF5252', addSuccessText: '#111827' },
  'white-graphite': { addSuccess: '#B8F000', addSuccessText: '#18181B' },
  'white-blush': { addSuccess: '#FF9EC0', addSuccessText: '#7A3A52' },
