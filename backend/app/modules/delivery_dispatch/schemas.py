...
class AssignmentSettingsUpdate(BaseModel):
    ...
    max_extra_route_meters: int | None = Field(default=None, ge=0)
    max_pickup_detour_meters: int | None = Field(default=None, ge=0)
    max_destination_detour_meters: int | None = Field(default=None, ge=0)
