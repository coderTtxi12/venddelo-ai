...
class RestaurantCreate(BaseModel):
    ...
    live_menu_social_enabled: bool = False
    live_menu_social_facebook_enabled: bool = False
...
class RestaurantUpdate(BaseModel):
    ...
    whatsapp_phone: str | None = None
    live_menu_social_enabled: bool | None = None
    live_menu_social_facebook_enabled: bool | None = None
