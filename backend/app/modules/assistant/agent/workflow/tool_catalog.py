...
TOOL_RETURNS_HINTS: dict[str, str] = {
    ...
    "generate_food_product_image": "storage_path, product context (generated asset).",
    # Restaurant settings
    "get_restaurant_name": "name, restaurant_id.",
    "get_restaurant_description": "description, name, restaurant_id.",
    "update_restaurant_description": "description, restaurant_id.",
    "get_restaurant_location": "address, latitude, longitude, place_id.",
    "update_restaurant_location": "address, latitude, longitude, place_id.",
    "get_restaurant_public_menu_url": "public_menu_url, subdomain, name.",
    "get_restaurant_menu_qr": "qr_encodes_url, public_menu_url, subdomain, name.",
    ...
    "get_delivery_provider_schedules": "has_active_delivery_provider, schedules[].",
    "get_restaurant_payment_methods": "payment_methods[] (method, service_type, enabled).",
    "set_restaurant_payment_methods": "payment_methods[] replaced (full replace-all).",
    "get_delivery_provider_payment_methods": "has_active_delivery_provider, payment_methods[].",
